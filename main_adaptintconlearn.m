%% MAINSCRIPT ADAPTIVE CONTROLLER WITH INTEGRAL CONCURRENT LEARNING
clc; clear; close all;

global p1 p2 p3 fd1 fd2 K1 K2 alpha gamma intofY4 Ts YsYs_sum YsTs_sum flagintcon del_t   timehistory tauhistory qhistory qdothistory prevcheck tvec mineigvec
...
[time,X_Sol]=ode113(@ode_adaptintconlearn,tspan,X0,options);
